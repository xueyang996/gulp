...
(function (factory) {
    ...
    var Page = function (element, options) {
        ...
        // this.$page = $('<ul class="m-pagination-page"></ul>').css("visibility", "hidden").css("position", "fixed");
        // this.$size = $('<div class="m-pagination-size"></div>').css("visibility", "hidden").css("position", "fixed");
        // this.$jump = $('<div class="m-pagination-jump"></div>').css("visibility", "hidden").css("position", "fixed");
        // this.$info = $('<div class="m-pagination-info"></div>').css("visibility", "hidden").css("position", "fixed");
    ...
    Page.prototype = {
        ...
        initHtml: function () {
            ...
            // 添加文字
            this.$size.prepend("<span style='vertical-align:middle;'>每页显示：&nbsp;</span>").append("<span style='vertical-align:middle;'>&nbsp;条</span>");
        ...
        renderPagination: function () {
            ...
            // this.currentPageIndex = lastPageNum > 0 && this.currentPageIndex > lastPageNum - 1 ? lastPageNum - 1 : this.currentPageIndex;
            // this.$page.empty().append(pagination.core.renderPages(this.currentPageIndex, this.currentPageSize, this.total, this.options.pageBtnCount, option)).css("visibility", "visible").css("position", "relative");
            // if (this.options.showPageSizes && lastPageNum !== 0) this.$size.css("visibility", "visible").css("position", "relative"); else this.$size.css("visibility", "hidden").css("position", "fixed");
            // if (this.options.showJump && lastPageNum !== 0) this.$jump.css("visibility", "visible").css("position", "relative"); else this.$jump.css("visibility", "hidden").css("position", "fixed");
            // this.$info.text(pagination.core.renderInfo(this.currentPageIndex, this.currentPageSize, this.total, this.options.infoFormat, this.options.noInfoText));
            // if (this.options.showInfo) this.$info.css("visibility", "visible").css("position", "relative"); else this.$info.css("visibility", "hidden").css("position", "fixed");
